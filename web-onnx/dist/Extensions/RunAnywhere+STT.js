 ...
 */
import { RunAnywhere, SDKError, SDKErrorCode, SDKLogger, EventBus, SDKEventType, AnalyticsEmitter, AudioFileLoader, } from '@runanywhere/web';
...
class STTImpl {
    ...
    async transcribe(audioSamples, options = {}) {
        ...
        try {
            ...
            AnalyticsEmitter.emitSTTTranscriptionCompleted(crypto.randomUUID(), this._currentModelId, transcription.text, transcription.confidence, processingTimeMs, audioDurationMs, audioSamples.length * 4, wordCount, rtf, '', sampleRate, RAC_FRAMEWORK_ONNX);
