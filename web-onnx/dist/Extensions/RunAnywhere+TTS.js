...
class TTSImpl {
    ...
    async synthesize(text, options = {}) {
        ...
        try {
            ...
            AnalyticsEmitter.emitTTSSynthesisCompleted(crypto.randomUUID(), this._currentVoiceId, text.length, durationMs, numSamples * 4, processingTimeMs, charsPerSec, sampleRate, RAC_FRAMEWORK_ONNX);
